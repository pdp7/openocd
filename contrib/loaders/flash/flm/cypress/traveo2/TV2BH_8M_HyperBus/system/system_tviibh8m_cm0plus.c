...
void SystemInit (void)
{
    ...
    // temporary VCCD trim fix in SFLASH.
    {
        ...
        CY_SET_REG32(0x4026321C, 0x08600f17);
    }

#if (CY_SYS_VCCD_SOURCE == CY_SYS_VCCD_PASS_TR)
    Cy_PMIC_Switch_IntToPassTR(0x8u);
#endif
    ...
    for(int8_t i_clkHfNo = 0ul; i_clkHfNo < 8; i_clkHfNo++)
    {
        ...
        {
            /***   Enabling MONZA PMIC     ***/
            Cy_PMIC_Switch_IntToPMIC(0x10u, CY_REGHC_PMIC_CTL_ENABLE_HIGH, CY_REGHC_PMIC_STS_ABNORMAL_LOW);
        }

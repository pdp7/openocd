APPLICATION := TV2BH_8M_HyperFlash
CPU_FLAGS   := -mthumb -mcpu=cortex-m0plus -msoft-float
GLOBAL_DEFS := -DCY_USE_PSVP=1 -DCYT4BFCCHE -Dtviibh8m -DHYPER_FLASH
#GLOBAL_DEFS := -DCY_USE_PSVP=0 -DCYT4BF8CES -Dtviibh8m -DHYPER_FLASH

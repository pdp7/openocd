...
#if defined (tviibh8m)
//MYKT    #include "cpu/cy_cpu.h"
//MYKT    #include "flexray/cy_fr.h"
//MYKT    #include "sd_host/cy_sd_host.h"
//MYKT    #include "audioss/cy_i2s.h"
    #include "smif/cy_smif.h"
    #include "smif/cy_smif_hb_flash.h"
//MYKT#    #include "smif/cy_smif_memslot.h"
#include "smif/cy_smif_s25fl.h"
//MYKT    #include "ethernet/cy_ethif.h"

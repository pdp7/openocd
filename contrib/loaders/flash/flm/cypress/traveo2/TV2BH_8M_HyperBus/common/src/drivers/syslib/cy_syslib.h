...
*******************************************************************************/
	...
	#define CY_SECTION(name)    __attribute__ ((section(name)))
	#define CY_NOINIT           CY_SECTION(".noinit")
	#define CY_UNUSED           __attribute__ ((unused))
	#define CY_ALIGN(align)     __ALIGNED(align)
	#define CY_WEAK             __WEAK
...
/** \endcond */
	...
	extern CY_NOINIT char_t cy_assertFileName[CY_MAX_FILE_NAME_SIZE];  /**< Assert buffer */
	extern CY_NOINIT uint32_t cy_assertLine;                           /**< Assert line value */
#endif /* NDEBUG */

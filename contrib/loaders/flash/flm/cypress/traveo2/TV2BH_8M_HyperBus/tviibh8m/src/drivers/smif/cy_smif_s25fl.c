                                        ...
                                        cy_stc_smif_context_t const *context)
{
    cy_en_smif_status_t status;
    status = Cy_SMIF_TransmitCommand(base,
                                     CY_SMIF_CMD_RDCR,     /* command value */
                                     false,
                                     CY_SMIF_WIDTH_SINGLE, /* command width */
                                     CY_SMIF_SDR,          /* command rate */
                                     NULL,                 /* Data pointer */
                                        ...
                                        cy_stc_smif_context_t const *context)
{
    cy_en_smif_status_t status;
    uint8_t writeData[2];
    writeData[0] = writeStatusData;
    writeData[1] = writeConfigData;
    status = Cy_SMIF_TransmitCommand(base,
                                     CY_SMIF_CMD_WRR,      /* command value */
                                     false,
                                     CY_SMIF_WIDTH_SINGLE, /* command width */
                                        ...
                                        cy_stc_smif_context_t const *context)
{
    ...
    status = Cy_SMIF_TransmitCommand(base,
                                     CY_SMIF_CMD_PNVDLR,   /* command value */
                                     false,
                                     CY_SMIF_WIDTH_SINGLE, /* command width */
                                     CY_SMIF_SDR,          /* command rate */
                                     &writeData,           /* Data pointer */
                                        ...
                                        cy_stc_smif_context_t const *context)
{
    ...
    status = Cy_SMIF_TransmitCommand(base,
                                     CY_SMIF_CMD_WVDLR,    /* command value */
                                     false,
                                     CY_SMIF_WIDTH_SINGLE, /* command width */
                                     CY_SMIF_SDR,          /* command rate */
                                     &writeData,           /* Data pointer */
...
{
    cy_en_smif_status_t status;
    en_cy_smif_s25fl128_cmd_t eraseCmd;
    uint8_t  addrSizeInByte;
    uint32_t addrInBigEndian;
...
/*******************************************************************************
* Function Cy_SMIF_S25FL_BulkErase
****************************************************************************//**
*
* \param
*
                                        ...
                                        cy_stc_smif_context_t const *context)
{
    cy_en_smif_status_t status;
    status = Cy_SMIF_TransmitCommand(base,
                                     CY_SMIF_CMD_RESET,    /* command value */
                                     false,
                                     CY_SMIF_WIDTH_SINGLE, /* command width */
                                     CY_SMIF_SDR,          /* command rate  */
                                     NULL,                 /* Data pointer  */

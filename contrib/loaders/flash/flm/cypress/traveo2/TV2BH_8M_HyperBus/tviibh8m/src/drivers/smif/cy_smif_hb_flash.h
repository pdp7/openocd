...
#define CY_SMIF_FLASH_OFFSET(b,o)       (*(( (volatile CY_SMIF_FLASHDATA*)(b) ) + (o)))
  ...
  #ifdef CY_SMIF_TRACE
    #define CY_SMIF_FLASH_WR(b,o,d)         FlashWrite( b,o,d )
    #define CY_SMIF_FLASH_RD(b,o)           FlashRead(b,o)
  #else
    #ifdef CY_SMIF_EXTEND_ADDR
      #define CY_SMIF_FLASH_WR(b,o,d)     FlashWrite_Extend(b,o,d)
      #define CY_SMIF_FLASH_RD(b,o)       FlashRead_Extend(b,o) 
    #else
      #ifdef CY_SMIF_USER_SPECIFIC_CMD
        #define CY_SMIF_FLASH_WR(b,o,d) FlashWriteUserCmd((CY_SMIF_ADDRESS) ((volatile CY_SMIF_FLASHDATA *)(b) + (CY_SMIF_ADDRESS)o),d)
        #define CY_SMIF_FLASH_RD(b,o) FlashReadUserCmd((CY_SMIF_ADDRESS) ((volatile CY_SMIF_FLASHDATA *)(b) + (CY_SMIF_ADDRESS)o))
      #else
        #ifdef CY_SMIF_USER_SPECIFIC_CMD_2 // cy_smif_hb_flash LLD verification IO
          #define CY_SMIF_FLASH_WR(b,o,d)         ApiDrvLLDWriteWord(o,d )
          #define CY_SMIF_FLASH_RD(b,o)           ApiDrvLLDReadWord(o)
        #else
          #define CY_SMIF_FLASH_WR(b,o,d) CY_SMIF_FLASH_OFFSET((b),(o)) = (d)
          #define CY_SMIF_FLASH_RD(b,o)   CY_SMIF_FLASH_OFFSET((b),(o))          
        #endif //#ifdef CY_SMIF_USER_SPECIFIC_CMD_2
      #endif //#ifdef CY_SMIF_USER_SPECIFIC_CMD
    #endif // #ifdef CY_SMIF_EXTEND_ADDR
  #endif // #ifdef CY_SMIF_TRACE

...
__STATIC_INLINE cy_en_smif_status_t Cy_SMIF_SetMode(volatile stc_SMIF_t *base, cy_en_smif_mode_t mode);
...
* \{
*/
//MYKTcy_en_syspm_status_t Cy_SMIF_DeepSleepCallback(cy_stc_syspm_callback_params_t *callbackParams);
//MYKTcy_en_syspm_status_t Cy_SMIF_HibernateCallback(cy_stc_syspm_callback_params_t *callbackParams);
/** \} */
...
__STATIC_INLINE cy_en_smif_status_t Cy_SMIF_TimeoutRun(uint32_t *timeoutUnits)
{
	...
	if (*timeoutUnits > 0u)
	{
//BHDT Cy_SysLib_DelayUs(CY_SMIF_WAIT_1_UNIT);
		for(volatile uint32_t i = 100; i; i--);
		--(*timeoutUnits);
